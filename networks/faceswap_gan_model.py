...
class FaceswapGANModel():
    ...
    def __init__(self, **arch_config):
        ...
        # build_encoder(通道数:3,输入尺寸:64,use_self_attn:True,norm:instancenorm,model_capacity:standard)
    ...
    def build_encoder(nc_in=3,
        ...
        # 从upscale_nn与upscale_ps函数中选择upscale_ps
        activ_map_size = input_size
        use_norm = False if (norm == 'none') else True
        #print(coef, latent_dim, upscale_block, activ_map_size, use_norm)
