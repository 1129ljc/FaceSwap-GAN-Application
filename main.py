...
def test(input_a, input_b, input_c):
    ...
    # 源文件读取
    souce_file = str(input_arg_ext_json['Source'])
    print('souce_file', souce_file)
...
if __name__ == '__main__':
    ...
    # python FaceSwap_GAN_v2.2_video_conversion.py --input ./test_video/test.mp4 --output ./test_result/result.mp4 --face-size 64 -g 0 --model-dir ./model/model_1_2 --merge-type AtoB --mode video
